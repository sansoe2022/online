...
<body>
    ...
    <script>
        ...
        const servers = {
            ...
            '🇹🇭 Free 1': [
                'http://svpnfree1feb.sksvpn.shop:81/server/online',
                'http://svpnfree1feb.sksvpn.shop:81/udpserver/online'
            ],
            '🇹🇭 Free 2': [
                'http://svpnfree2feb.sksvpn.shop:81/server/online',
                'http://svpnfree2feb.sksvpn.shop:81/udpserver/online'
            ],
            '🇹🇭 Free 3': [
                'http://svpnfree3feb.sksvpn.shop:81/server/online',
            ...
            '🇹🇭 Free 8': [
                ...
                'http://svpnfree8feb.sksvpn.shop:81/udpserver/online'
            ],
            '🇹🇭 Free 9': [
                'http://svpnfree9feb.sksvpn.shop:81/server/online',
                'http://svpnfree9feb.sksvpn.shop:81/udpserver/online'
            ],
            '🇹🇭 Free 10': [
                'http://svpnfree10feb.sksvpn.shop:81/server/online',
                'http://svpnfree10feb.sksvpn.shop:81/udpserver/online'
            ],
        };
